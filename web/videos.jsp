...
<html>
    <head>
      ...
      <style>
        ...
        .card { background-color: rgba(245, 245, 245, 0.6); }
  ...
  <div class="card-body">
    <p class="card-text">Revivez les meilleurs moment de Kylian Mbappé.</p>
            ...
            <div class="card" style="width: 20rem; margin-top:5%; margin-left:34.5%; background-color: beige; position:absolute;">
                <div class="card-header" style="background-color: rgb (0,150,136); text-align: center; font-weight: bold;">Paris c'est magique</div>
  <iframe width="300" height="200"
src="https://www.youtube.com/embed/wuQfzGBUo2I" style="margin:auto; margin-top:5%;" allowfullscreen>
</iframe>
  <div class="card-body">
    <p class="card-text">Le résumé du meilleur match du QSG en ligue des champions.</p>
  </div>
</div>
            
             <div class="card" style="width: 20rem; margin-top:5%; margin-left:65%; background-color: beige; position:absolute;">
                <div class="card-header" style="background-color: rgb (0,150,136); text-align: center; font-weight: bold;">Ronaldinho>Neymar (et moins cher en plus)</div>
  <iframe width="300" height="200"
src="https://www.youtube.com/embed/DDvsqjr8ns8" style="margin:auto; margin-top:5%;"allowfullscreen>
</iframe>
  <div class="card-body">
    <p class="card-text">Ronaldinho, regretté par les fans du PSG.</p>
  </div>
</div>
